    ...
    stages {
        ...
        stage ('Run  Waarp R66'){
            ...
            steps {
                ...
                // Start database
                sh "docker run -d --name 'waarp-r66-pg-${BUILD_NUMBER}' -e PORSTGRES_DB=waarp -e POSTGRES_USER=waarp -e POSTGRES_PASSWORD=V3ry1ns3cur3P4ssw0rd --network waarp-r66-${BUILD_NUMBER} amd64/postgres:9.6"
                sleep 60
                // Start application
